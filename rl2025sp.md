...
| 1/15 | **Bandits (value-based)**: Explore-then-exploit, &epsilon;-greedy | [Slides](/rl2025sp_files/bandits1.pdf){:target="_blank"}, [Recording](https://virginia.zoom.us/rec/share/6r_YblVPYKHMTHvusfD9ybQJuCtAfX2tcCqkVqBJ5GEyN9DNZEcrnVgI_wU-QYWY.WL2zs2sFlOWpUf_e){:target="_blank"} |  |
| 1/20 | MLK Holiday |  |  | 
| 1/22 | **Bandits (value-based)**: Boltzmann exploration, Inverse gap weighting, Reduction | [Recording](https://virginia.zoom.us/rec/share/mpNKMAsgr_RpvKJi5jE2fpHc2rjvx35LLGJNPQzMZboSOJlSmqz3hpd_TaL23k9T.0Ly0ut2A7fyfiJy6){:target="_blank"}, [Supp-IGW](/rl2025sp_files/igw.pdf){:target="_blank"} |  |
| 1/27 | **Bandits (value-based)**: UCB, LinUCB |  | HW1 out |
| 1/29 | **Bandits (policy-based)**: Exponential weights (full-information) |  |  |
| 2/3 | **Bandits (policy-based)**: EXP3 |  |  |
| 2/5 | **Bandits (policy-based)**: PPO, NPG |  | HW2 out, HW1 due on 2/7 |
| 2/10 |  |  |  |
| 2/12 |  |  |  |
