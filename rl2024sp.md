...
| 3/20 |  |  |  |
| 3/25 | **Policy-based learning methods**: least-square policy iteration (LSPI), policy gradient, natural policy gradient | [Slides](https://bahh723.github.io/rl2024sp_files/policy-learning.pdf){:target="_blank"} <br> Notes of [J](https://sites.google.com/view/cjin/teaching/ele524-2020-ver){:target="_blank"} on 3/24-3/31 <br> Lec. 5, 6, 9 of Sergey Levine's [course](https://www.youtube.com/playlist?list=PL_iWQOsE6TfVYGEGiAOMaOzzv41Jfm_Ps){:target="_blank"} <br> W. van Heeswijk's [paper](https://arxiv.org/pdf/2209.01820.pdf){:target="_blank"} |  |
| 3/27 |  |  | Project milestone due on 3/29 |
| 4/1 |  |  |  |
| 4/3 | **Actor-critic methods**: advantage actor-critic (A2C), proximal policy optimization (PPO), deep deterministic policy gradient (DDPG), twin-delayed DPG (TD3), soft actor-critic (SAC) | [Slides](https://bahh723.github.io/rl2024sp_files/actor-critic.pdf){:target="_blank"} <br> Algorithms Docs in [Spinning Up](https://spinningup.openai.com/en/latest/){:target="_blank"} <br> References in the slides | [HW3](https://bahh723.github.io/rl2024sp_files/HW3.pdf){:target="_blank"} due on 4/7 |
| 4/8 |  |  |  |
| 4/10 |  |  |  |
