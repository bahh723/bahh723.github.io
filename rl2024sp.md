...
| 2/26 |  |  |  |
| 2/28 | **Approximate value iteration**: least-square value iteration, state-space exploration | [Slides](https://bahh723.github.io/rl2024sp_files/vi-based.pdf){:target="_blank"} <br> Ch. 3, 7 of [AJKS](https://rltheorybook.github.io/rltheorybook_AJKS.pdf){:target="_blank"} | |
| 3/4 | Spring recess |  |  |
| 3/6 | Spring recess |  |  |
| 3/11 |  |  |  |
