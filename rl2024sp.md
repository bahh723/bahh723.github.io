...
| 2/19 | **Basics of Markov decision processes**: Bellman (optimality) equations, reverse Bellman equations, value iteration, (modified) policy iteration, performance difference lemma | [Slides](https://bahh723.github.io/course/mdp.pdf){:target="_blank"} <br> Ch. 1.1-1.3 of [AJKS](https://rltheorybook.github.io/rltheorybook_AJKS.pdf){:target="_blank"} <br> Ch. 3 of [SB](http://incompleteideas.net/book/RLbook2020.pdf){:target="_blank"} |  |
| 2/21 |  |  | HW1 due on 2/23 |
| 2/26 |  |  |  |
| 2/28 | **Approximate Value Iteration** | [Slides](https://bahh723.github.io/course/vi-based.pdf){:target="_blank"} |  |
| 3/4 | Spring recess |  |  |
| 3/6 | Spring recess |  |  |
| 3/11 |  |  |  |
| 3/13 |  |  |  |
