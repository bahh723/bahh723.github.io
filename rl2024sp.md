...
| 3/4 | Spring recess |  |  |
| 3/6 | Spring recess |  |  |
| 3/11 | **Approximate value iteration**: least-square value iteration, Watkins's Q-learning, deep Q-learning, prioritized replay, double Q-learning | [Slides](https://bahh723.github.io/rl2024sp_files/vi-based.pdf){:target="_blank"} <br> Ch. 3, 7 of [AJKS](https://rltheorybook.github.io/rltheorybook_AJKS.pdf){:target="_blank"} <br> Lec. 7, 8 of Sergey Levine's [course](https://www.youtube.com/playlist?list=PL_iWQOsE6TfVYGEGiAOMaOzzv41Jfm_Ps){:target="_blank"} |  |
| 3/13 |  |  | HW2 due on 3/17 |
| 3/18 | **Policy evaluation**: least-square policy evaluation, temporal difference learning | [Slides](https://bahh723.github.io/rl2024sp_files/policy-eval.pdf){:target="_blank"} <br> Ch. 5.1, 5.2, 5.5, 6.1-6.3, 9.1-9.4, 11.1-11.3, 12.1-12.5 of [SB](http://incompleteideas.net/book/RLbook2020.pdf){:target="_blank"} |  |
| 3/20 |  |  |  |
| 3/25 |  |  |  |
