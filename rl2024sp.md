...
| 4/1 |  |  |  |
| 4/3 | **Actor-critic methods**: advantage actor-critic (A2C), proximal policy optimization (PPO), deep deterministic policy gradient (DDPG), twin-delayed DPG (TD3), soft actor-critic (SAC) | [Slides](https://bahh723.github.io/rl2024sp_files/actor-critic.pdf){:target="_blank"} | [HW3](https://bahh723.github.io/rl2024sp_files/HW3.pdf){:target="_blank"} due on 4/7 |
| 4/8 |  |  |  |
| 4/10 |  |  |  |
